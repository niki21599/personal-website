    ...
    <div id="portfolio" className="black-background portfolioContainer">
      ...
      <div className="projectContainer">
        <div className="projectCard ">
          <img src="/kanban.png" alt="" className="project-img" />
        ...
        <div className="projectCard ">
          <img src="/chat2.0..jpg" alt="" className="project-img" />
          <div className="overlay ">
        ...
        <div className={"projectCard "}>
          <img src="/crm.jpg" alt="" className="project-img" />
          <div className="overlay ">
        ...
        <div className={"projectCard "}>
          <img src="/videotube.jpg" alt="" className="project-img" />
          <div className="overlay ">
